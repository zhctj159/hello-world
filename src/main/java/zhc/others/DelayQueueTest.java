...
public class DelayQueueTest {
    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(() -> {
            ...
            while (test.isStarted == 1) {
                try {
                    Order order = test.queue.take();
        ...
        Thread t2 = new Thread(() -> {
            ...
            test.queue.add(new Order("SO001", 100, "CREATED", new Date(beginTime), new Date(beginTime + 3000)));
            beginTime += 3000L;
            test.queue.add(new Order("SO002", 100, "CREATED", new Date(beginTime), new Date(beginTime + 3000)));
            beginTime += 3000L;
            test.queue.add(new Order("SO003", 100, "CREATED", new Date(beginTime), new Date(beginTime + 3000)));
        });
        t2.start();
    }
}
